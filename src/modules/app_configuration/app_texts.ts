export const website_title = 'Webentwicklung Online Kurs';export const navbar_title = 'Grundlagen Webentwicklung';export const welcome_headline = 'Willkommen zur Webentwicklungslernplattform!';export const welcome_description = 'Hier finden Sie Unterrichtseinheiten über HTML, CSS, JS und allgemeine Webentwicklung. Die Plattform bietet zahlreiche Coding-Übungen mit einem Live-Editor und einer Überprüfung der Aufgaben. ';export const footer_text = '© 2025 Christian Scheub. All rights reserved.';
...
export const impressum_text = 'Angaben gem. § 5 TMG: <br />Christian Scheub<br />Ziegeläcker 56<br />71560 Sulzbach an der Murr <br /><br />Kontaktaufnahme: <br />Telefon: +49 176 21674883 <br />E-Mail: christian.developer.app@gmail.com<br /><br />Urheberrecht: <br />Die durch die Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechts bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und Kopien dieser Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet. <br />Soweit die Inhalte auf dieser Seite nicht vom Betreiber erstellt wurden, werden die Urheberrechte Dritter beachtet. Insbesondere werden Inhalte Dritter als solche gekennzeichnet. Sollten Sie trotzdem auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen entsprechenden Hinweis. Bei Bekanntwerden von Rechtsverletzungen werden wir derartige Inhalte umgehend entfernen.';