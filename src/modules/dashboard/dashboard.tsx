...
const Dashboard: React.FC = () => {
  ...
  const currentUserAccount = userAccountsList.find(
    (user) => user.idToken === idToken
  );
  const progressEnabled =
    localStorage.getItem("progress-saving-enabled") != null;
  ...
  return (
    <div>
      <div className="after-login-container">
        {currentUserAccount && !featureFlag_DeployMobile && (
          <div>
            <Card style={{ width: "90vw", top: "2vw" }}>
              <Card.Header as="h2">
                <MdArrowBack
              ...
              <Card.Body>
                <Card.Text>
                  ...
                  {currentUserAccount.description}
                </Card.Text>
                <Card.Text>
                  <strong>Lizenzdauer: </strong>{" "}
                  {currentUserAccount.licenseDuration}
                </Card.Text>
              </Card.Body>
            </Card>
                  ...
                  return (
                    <div key={category}>
                      <Card.Text>
                        ...
                        />
                        <Card.Text>
                          Erfolgreich abgeschlossene Einheiten: {completed} (XP:{" "}
                          {completedXP})
                        </Card.Text>
                        <Card.Text>
                          Ausstehende Einheiten: {pending} (XP: {pendingXP})
                        </Card.Text>
                        <br />
                      </Card.Text>
                    </div>
